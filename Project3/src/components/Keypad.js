...
const Keypad = ({
  ...
  return (
    <>
      <div>
        <Key text={"MC"} memory onClick={onPressMC} />
        <Key text={"MR"} memory onClick={onPressMR} />
        <Key text={"M+"} memory onClick={onPressM_Add}/>
        <Key text={"M-"} memory onClick={onPressM_Subtract} />
        <Key text={"MS"} memory onClick={onPressMS} />
      </div>
      <div>
